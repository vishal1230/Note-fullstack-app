...
const SignUpPage: React.FC = () => {
    ...
    const handleGetOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Failed to send OTP. User might already exist.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Sign up failed. Invalid OTP or server error.');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="w-full max-w-xs mx-auto">
                ...
                {step === 2 && (
                    <form onSubmit={handleSignUp}>
                            <div className="mb-4">
                            <p className="text-sm text-gray-600">An OTP has been sent to <span className="font-semibold">{formData.email}</span>.</p>
